...
const CreatePost = () => {
  ...
  // This will check keypress event for form
  ...
  return (
    <seaction className="max-w-7xl mx-auto">
      <div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created you want, you can share it with other with
            other in the community
          </p>
          <button
            type="submit"
            className="mt-3 text-white bg-[#6469ff] font-medium rounded text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
